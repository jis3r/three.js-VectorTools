...
function linearFunctionParametersFactor ( startP, endP )
{
...
function verifyVerticalLineFactor(startP, endP)
{
...
function calcIntersectionFactor(parameterL1, parameterL2)
{
...
function lineSegmentIntersectionFactor( startL1, endL1, startL2, endL2 ) 
{
    ...
    if( verifyVerticalLineFactor(startL1, endL1) )
    {
    ...
    else if( verifyVerticalLineFactor(startL2, endL2) )
    {
    ...
    {
        let parameterL1 = linearFunctionParametersFactor( startL1, endL1 );
        let parameterL2 = linearFunctionParametersFactor( startL2, endL2 );
        ...
        intersection = calcIntersectionFactor(parameterL1, parameterL2);
    }
...
export {lineSegmentIntersectionFactor, linearFunctionParametersFactor, verifyVerticalLineFactor, verifyIntersectionFactor, calcIntersectionFactor};
//export default lineSegmentIntersectionFactor;